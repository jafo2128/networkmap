...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/ammap/ammap.css" type="text/css">
        <script src="${pageContext.request.contextPath}/resources/ammap/ammap.js" type="text/javascript"></script>
        <!-- map file should be included after ammap.js -->
		<script src="${pageContext.request.contextPath}/resources/ammap/maps/js/usaLow.js" type="text/javascript"></script>
		...
		<script type="text/javascript">
			...
			AmCharts.ready(function() {
			    ...
			    map.pathToImages = "${pageContext.request.contextPath}/resources/ammap/images/";
